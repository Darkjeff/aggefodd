...
ALTER TABLE llx_agefodd_formateur ADD COLUMN fk_user integer;
ALTER TABLE llx_agefodd_formateur ADD COLUMN type_trainer varchar(20);
ALTER TABLE llx_agefodd_formateur DROP FOREIGN KEY llx_agefodd_formateur_ibfk_1;
ALTER TABLE llx_agefodd_formateur ADD COLUMN entity integer NOT NULL DEFAULT 1;
...
ALTER TABLE llx_agefodd_formation_catalogue ADD COLUMN ref_interne varchar(80) NULL;
ALTER TABLE llx_agefodd_contact ADD COLUMN entity integer NOT NULL DEFAULT 1;
