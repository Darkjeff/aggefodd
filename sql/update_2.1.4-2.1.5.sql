ALTER TABLE llx_agefodd_session ADD COLUMN fk_product integer NULL;
ALTER TABLE llx_agefodd_session ADD COLUMN status integer DEFAULT NULL;
ALTER TABLE llx_agefodd_session ADD COLUMN duree_session integer NOT NULL DEFAULT 0;
ALTER TABLE llx_agefodd_session ADD COLUMN intitule_custo varchar(80) DEFAULT NULL;
