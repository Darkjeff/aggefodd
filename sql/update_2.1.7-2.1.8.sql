...
ALTER TABLE llx_agefodd_session_element ADD COLUMN fk_soc integer NOT NULL DEFAULT 0;
...
ALTER TABLE llx_agefodd_convention ADD COLUMN element_type varchar(50) DEFAULT NULL;
ALTER TABLE llx_agefodd_convention ADD COLUMN fk_element integer DEFAULT NULL;
ALTER TABLE llx_agefodd_convention ADD COLUMN model_doc	varchar(200) DEFAULT NULL;
...
ALTER TABLE llx_agefodd_session ADD COLUMN is_date_res_confirm_site smallint NOT NULL DEFAULT 0;
ALTER TABLE llx_agefodd_session ADD COLUMN date_res_confirm_site datetime DEFAULT NULL;

ALTER TABLE llx_agefodd_session ADD COLUMN fk_soc_requester int NULL;
ALTER TABLE llx_agefodd_session ADD COLUMN fk_socpeople_requester int NULL;
ALTER TABLE llx_agefodd_session ADD INDEX fk_soc_requester_session (fk_soc_requester);

ALTER TABLE llx_agefodd_session_stagiaire ADD COLUMN fk_soc_link integer NULL;
ALTER TABLE llx_agefodd_session_stagiaire ADD COLUMN fk_soc_requester integer NULL;
