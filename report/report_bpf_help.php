...
print "<br>\n";
print "<br>\n";
print img_picto('', 'puce').' '.$langs->transnoentities("AgfBPFCg",'<strong>'.$langs->transnoentities('AgfReportBPFCategProdPeda').'</strong>','<strong>'.$langs->transnoentities('AgfReportBPFCategFAF').'</strong>');
print "<br>\n";
print "<br>\n";
...
print "<br>\n";
print "<br>\n";
print img_picto('', 'puce').' '.$langs->transnoentities("AgfBPFC3",'<strong>'.$langs->transnoentities('AgfReportBPFCategProdPeda').'</strong>','<strong>'.$langs->transnoentities('AgfReportBPFCategAdmnistration').'</strong>');
print "<br>\n";
print "<br>\n";
...
print "<br>\n";
print "<br>\n";
print img_picto('', 'puce').' '.$langs->transnoentities("AgfBPFD1",'<strong>'.$langs->transnoentities('AgfCategOverheadCost').'</strong>');
print "<br>\n";
print "<br>\n";
print img_picto('', 'puce').' '.$langs->transnoentities("AgfBPFD2",'<strong>'.$langs->transnoentities('AgfReportBPFCategFeePresta').'</strong>','<strong>'.$langs->transnoentities('AgfReportBPFCategPresta').'</strong>');
print "<br>\n";
print "<br>\n";
